...
def _maak_rister_df(n=10):
    ...
    # Numerieke kolommen
    for col in ["med_ervaring_bewerking", "med_klant_bezoeken", "med_gem_tijd",
                "med_std_tijd", "med_aantal_opdrachten", "taak_gem",
                "med_klant_ratio", "med_klant_snelheid", "med_bewerking_snelheid",
                "med_klant_gem_tijd", "med_bewerking_gem_tijd", "med_totaal_opdrachten",
                "lat", "lon", "hoeveelheid_big_bag", "hoeveelheid_dag",
                "hoeveelheid_hectare", "hoeveelheid_kubieke_meter",
...
def test_suitability_score_max_per_groep_is_een():
    ...
    for groep in ["A", "B"]:
        ...
        assert abs(max_score - 1.0) < 1e-5, f"Max suitability in groep {groep} is {max_score}, verwacht 1.0"
